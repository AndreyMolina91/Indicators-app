...
export class UtmChartComponent implements OnInit {

  indicatorUtmModel: IndicatorModel = {
    version: '',
    autor: '',
    codigo: '',
    nombre: '',
  ...
  ngOnInit(): void {
    ...
    this.services.getIndicatorsUtm().subscribe((res: any) => {
      ...
      console.log(this.indicatorUtmModel);

      //INICIO DEL CHART
      Highcharts.chart('containerUtm', {
        chart: {
          styledMode: true,
          type: 'areaspline'
        },
        ...
        yAxis: {
          title: {
            text: 'Fluctuación en el valor del UTM'
          }
        },
        tooltip: {
          shared: true,
  ...
  checkRecord(): void {
    this.services.getIndicatorsUtm().subscribe((data: any) => {
